...
//    {CAN1MBaud, (CAN_SJW_2TQ | CAN_BS1_4TQ  | CAN_BS2_3TQ | 4)},   //32MHz APB clock,for 1MHz baudrate
    {CAN1MBaud, (CAN_SJW_2TQ | CAN_BS1_4TQ  | CAN_BS2_3TQ | 4)},   //32MHz APB clock,for 500KHz baudrate
    {CAN800kBaud, (CAN_SJW_2TQ | CAN_BS1_5TQ  | CAN_BS2_3TQ | 5)},
//    {CAN500kBaud, (CAN_SJW_2TQ | CAN_BS1_8TQ  | CAN_BS2_3TQ | 6)},
    {CAN500kBaud, (CAN_SJW_2TQ | CAN_BS1_9TQ  | CAN_BS2_6TQ | 4)},
...
//    drv_init->Mode = RT_CAN_MODE_LOOPBACK;
...
//    filterConf->FilterMaskIdLow = 0xffff;
    filterConf->FilterIdHigh = 0x2000;
    filterConf->FilterIdLow = 0x0000;
    filterConf->FilterMaskIdHigh = 0xee0f;
    filterConf->FilterMaskIdLow = 0xffff;
