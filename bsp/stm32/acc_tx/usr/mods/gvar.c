...
{	//id		mapped registers		                 min	    max				    default			 type    chk_prt
    {	0,		&g_sys.conf.sync_period,                 20,		5000,               50,              0,       NULL},
    {	1,		&g_sys.conf.hwt_thl,                     10,		100,                48,              0,       NULL},
    ...
    {	6,		&g_sys.conf.com_addr,                    0,		    255,                8,               0,       NULL},
    {	7,		NULL,			                         0,		    0,                  0,               0,       NULL},
    {	8,		NULL,			                         0,		    0,                  0,               0,       NULL},
    {	9,		NULL,			                         0,		    0,                  0,               0,       NULL},
    ...
    {	15,		NULL,			                         0,		    0,                  0,               0,       sys_reset_opt},
};


const sts_reg_map_st status_reg_map_inst[STAT_REG_MAP_NUM]=
{// id			mapped registers																	
  {	0,          &g_sys.stat.ms_status,				     0},
  {	1,          &g_sys.stat.lc_addr,					 0},
  {	2,          NULL,						             0},
  {	3,          NULL,						             0},
  {	4,          NULL,						             0},
  {	5,          NULL,						             0},
